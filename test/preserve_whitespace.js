...
let options = { preserve_whitespace: true };


describe('Preserve whitespace', function () {
    describe('Basic', function () {
        let entry = " This is\ta  sentence   with  funny whitespace.  And this  is \tanother.\tHere  is   a third. ";
        let sentences = tokenizer.sentences(entry, options);
    ...
    describe('No effect if newline_boundaries are specified', function () {
        let entry = " This is\ta  sentence   with  funny whitespace. ";
        let sentences = tokenizer.sentences(entry, Object.assign({ newline_boundaries: true }, options));
    ...
    describe('No effect if html_boundaries are specified', function () {
        let entry = " This is\ta  sentence   with  funny whitespace. ";
        let sentences = tokenizer.sentences(entry, Object.assign({ html_boundaries: true }, options));
